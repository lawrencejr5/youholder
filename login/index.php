...
<body>
					...
					<nav class="navbar navbar-expand-md navbar-light">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ms-auto py-4 py-md-0 gilroy-medium nav-align">
								...
								<li class="nav-item ">
									<a href="https://demo.paymoney.techvill.net/crypto-exchange/create"
										class="nav-link"> Crypto Exchange</a>
								</li>
								...
								<li>
									<div class="color-parent mt-2p">
										<div class="switch">
											<div id="switch">
												<img src="./public/frontend/templates/images/home/moon.png"
													class="moon img-none" width="26px" alt="">
												<img src="./public/frontend/templates/images/home/sun2.png"
													class="img-none sun" width="26px" alt="">
											</div>
										</div>
									</div>
								</li>
								...
								<div class="d-flex">
									<a href="https://demo.paymoney.techvill.net/login"
										class="border d-flex align-items-center justify-content-center log-btn rounded ml-60 mt-n4p">
										Login
									</a>

									<a href="https://demo.paymoney.techvill.net/register"
										class="border d-flex align-items-center justify-content-center reg-btn rounded ml-18 mt-n4p">
										Register
									</a>
								</div>
							</ul>
							...
							<div class="transaction-image">
								<div class="static-image">
									<img class="img img-fluid"
										src="./public/frontend/templates/images/login/signin-static.svg">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="auth-section signin-top d-flex align-items-center">
						<div class="auth-module">
							<div class="d-flex align-items-center back-direction mb-2 back-signin">
								<a href="https://demo.paymoney.techvill.net"
									class="d-inline-flex align-items-center back-btn">
							...
							<form action="https://demo.paymoney.techvill.net/authenticate" method="post"
								id="login-form">
								<input type="hidden" name="_token" value="PFhVNJMPXGAl78xl7DN1x28WvuRvz2vpVljgxMPU"
									autocomplete="off"> <input type="hidden" name="has_captcha" value="Disabled">
								...
								<div class="auth-module-header">
									...
									<p class="mb-0 text-start auth-text mt-12"> Don’t have an account?<a
									...
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="email" class="form-control input-form-control"
												placeholder="Email Address" name="email_only" id="email_only"
										...
										<div class="d-grid mb-3 mb-3p">
											<button class="btn btn-lg btn-primary" type="submit" id="login-btn">
												...
												<span id="rightAngleSvgIcon"><svg class="position-relative ms-1"
														width="12" height="12" viewBox="0 0 12 12" fill="none"
														xmlns="http://www.w3.org/2000/svg">
														<path fill-rule="evenodd" clip-rule="evenodd"
															d="M3.5286 10.4698C3.26825 10.2094 3.26825 9.78732 3.5286 9.52697L7.05719 5.99837L3.5286 2.46978C3.26825 2.20943 3.26825 1.78732 3.5286 1.52697C3.78895 1.26662 4.21106 1.26662 4.47141 1.52697L8.47141 5.52697C8.73176 5.78732 8.73176 6.20943 8.47141 6.46978L4.47141 10.4698C4.21106 10.7301 3.78895 10.7301 3.5286 10.4698Z"
															fill="currentColor"></path>
													</svg></span>
										...
										<div class="forgot-link text-center mb-3 pt-1">
											<a href="https://demo.paymoney.techvill.net/forget-password">Forgot
												Password?</a>
										</div>
									</div>
								</div>
	...
	<!-- Start Footer-->
	<!-- Footer section -->
	<div class="footer-sec d-none">
		<div class="px-240">
			<div class="row">
				<div class="col-md-5 pb-54 align-center">
					<a class="d-flex" href="https://demo.paymoney.techvill.net">
						<img class="mt-54 footer-logo" src="./public/uploads/logos/1532175849_logo.png"
							alt="Brand Logo">
					</a>
					...
					<div class="mt-21 d-flex direction">
						<a href="http://store.google.com/pay-money" target="_blank">
							<img class="app-imgs" src="./public/uploads/app-store-logos/thumb/1531650482.png"
								alt="playstore">
						</a>
						<a href="https://itunes.apple.com/bd/app/pay-money" target="_blank">
							<img class="ms-3 ml-r12app-imgs" src="./public/uploads/app-store-logos/thumb/1531134592.png"
								alt="playstore">
						</a>
			...
			<div>
				<div class="d-flex align-center justify-center-res sp mt-18">
					...
					<div class="form-group OpenSans-600 selectParent footer-font-16 OpenSans-600">
						<select class="select2 form-control footer-font-16 mb-2n"
