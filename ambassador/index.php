...
<body>
    ...
    <div class="content-wrap wide w-container">
      <div class="w-row">
        ...
        <div class="column-compensation w-col w-col-9 w-col-stack">
          ...
          <p class="p">As a dear friend of ours, you can get exclusive gifts, YieldFincs branded merchandise, commission
          ...
          <p class="p">YieldFincs Ambassadors are our friends. They are passionate members of our community that support
            us in various ways, such as promoting the YieldFincs website and the app, providing feedback to improve our
            offers and services, and assisting new users with questions and concerns.</p><a class="btn-small-transparent show-on-mobile w-button">learn more</a>
        </div>
      </div>
    </div>
  </div>
  <div class="s-content wide">
    <div class="content-wrap wide last w-container">
      ...
      <div class="w-layout-grid grid-3-row"><a class="product-a w-inline-block w-clearfix">
