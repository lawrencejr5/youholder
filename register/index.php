								...
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group mb-3">
											...
											<input type="email" class="form-control input-form-control" id="email" name="email" value="" required oninvalid="this.setCustomValidity('This field is required.')" data-type-mismatch="Enter a valid email.">
										...
										<div class="form-group mb-3">
											...
											<div id="password-div" class="position-relative">
												<input type="password" class="form-control input-form-control" name="password" id="password" required oninvalid="this.setCustomValidity('This field is required.')" minlength="6" data-min-length="Password should contain at least 6 characters.">
	...
	<script type="text/javascript">
		...
		$(document).ready(() => {
			...
			registerBtn.on('click', () => {
				...
				if (pass !== cpass) {
					toastr.error("Passwords do not match!!!", "Confirm", {
