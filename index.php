...
<body>
  ...
  <div id="platform" class="s-content wide card-pre-order">
    <div class="content-wrap wide w-container">
      ...
      <div class="wrap-center">
        <h2 class="h2 center">Discover YieldFincs</h2>
      </div>
        ...
        <div class="product-tabs-content w-tab-content">
              ...
              <div class="column-compensation image-wrap-earn w-col w-col-12 w-col-stack">
                ...
                <div class="product-tabs-content-desktop">
                  <p>
                    ...
                    Pick a project, securely delegate with YieldFincs and make 10-50% income annually

                    Our team operates
                    promising PoS blockchains

                    Stake crypto with Yield Fincs.<br /></p>
          ...
          <div data-w-tab="Crypto Loans" class="product-tabs-pane w-tab-pane">
            <div class="w-row">
              <div class="column-compensation w-col w-col-12 w-col-stack">
                <div class="product-tabs-content-mobile">
                  <h3 class="h3">Instant crypto deposits</h3>
                  <p class="h3 subheading">Top-up your way with instant crypto deposits.</p>
                </div>
                <div class="product-tabs-content-desktop">
                  <p class="p">Securely and instantly deposit crypto currencies and swap to fiat or any other crypto with confidence.
              ...
              <div class="column-compensation image-wrap-convert w-col w-col-12 w-col-stack">
                ...
                <div class="product-tabs-content-desktop">
                  <p>A Bitcoin exchange and cryptocurrency exchange can be confusing, especially for newcomers. However,
                    it doesn’t have to be that way. Yieldfincs's app walks you through the crypto conversion so you can
          ...
          <div data-w-tab="Loyalty Program" class="product-tabs-pane w-tab-pane">
            <div class="w-row">
              <div class="column-compensation image-wrap-earn w-col w-col-12 w-col-stack">
                <div class="product-tabs-content-mobile">
                  <h3 class="h3">Earn <span class="span-blue">up to 37.9%</span> of investesd amount within 3 months.</h3>
                  <p class="h3 subheading">Boost your earnings.</p>
                </div>
                <div class="product-tabs-content-desktop">
                  <p>We carry out digital asset-winding on some assets or potential venture projects,
                    and solve financing difficulties or industry resource problems for SMEs,
                    increase liquidity, and accelerate the development of the project.
                    Meanwhile, the technology development of blockchain digital assets, quantification,
  ...
  <div class="s-content wide">
    <div class="content-wrap wide last w-container">
      <div class="wrap-center">
        <h2 class="h2 center">Media About YieldFincs</h2>
      </div>
      <ul role="list" class="media-ul w-list-unstyled">
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/63c7e979dbd853431d3ef83b_Bitmap.png" alt="cointelegraph" width="200" sizes="(max-width: 479px) 71vw, 200px" loading="lazy" srcset="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/63c7e979dbd853431d3ef83b_Bitmap-p-500.png 500w, https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/63c7e979dbd853431d3ef83b_Bitmap-p-800.png 800w, https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/63c7e979dbd853431d3ef83b_Bitmap.png 872w" class="media-logo" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/5e986134e2c467734bfb5c6d_Yahoo!_(2019).svg" alt="yahoo finance" width="100" loading="lazy" class="media-logo yahoo" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/5f02cfc1b8a3d2150e9717d5_money_mongers_logo.png" alt="the money mongers" width="200" loading="lazy" class="media-logo mongers" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/60ba219158b720bda1236ab9_bitcoins-logo.png" width="150" alt="99 Bitcoins" loading="lazy" class="media-logo" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/60ba1f9d7a2b8c34735612f8_p2p-empire.png" loading="lazy" alt="p2p empire" width="150" class="media-logo empire" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/60efdc7874d888e6ad763cd4_benzinga.png" loading="lazy" alt="benzinga" width="150" class="media-logo benzinga" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/61d2ed18f54a879c920c7855_logo%20mini%20_%20mod.png" loading="lazy" alt="beincrypto" width="150" class="media-logo" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/612f4fe7c980be0aa8f8a5fc_coindesk-logo.png" loading="lazy" alt="coindesk" width="150" class="media-logo coindesk" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/612f2dc1d09990855ad7d903_Tradingbeasts-logo.png" loading="lazy" alt="trading beasts" width="180" class="media-logo" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/633d527c9271a98290637818_Bloomberg_Logo.svg" loading="lazy" alt="coindesk" width="150" class="media-logo bloomberg" /></li>
        <li class="media-li"><img src="https://assets-global.website-files.com/5cc19fbd198b8d31a9c64876/63bd96c5fb81a88800a4c19c_FILE-05.svg" loading="lazy" alt="coindesk" width="180" class="media-logo" /></li>
      </ul>
    </div>
  </div>
