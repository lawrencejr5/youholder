...
<head>
    ...
    <title>Address Verification | Pay Money</title>
                                ...
                                <nav>
                                    <div class="nav-tab-parent d-flex justify-content-center mt-4">
                                        <div class="d-flex p-2 border-1p rounded-pill gap-1 bg-white nav-tab-child">
                                            <a href="../personal-verification" class="tablink-edit text-gray-100 ">Identity Verification</a>
                                            <a href="../address-verification" class="tablink-edit text-gray-100 tabactive">Address Verfication</a>
                                        </div>
                                    </div>
                                </nav>
                                <div class="mt-28 label-top">
                                    <form method="post" action="https://demo.paymoney.techvill.net/profile/personal-address-update" id="addressVerifyForm" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" value="8" name="existingAddressFileID" id="existingAddressFileID" />

                                        <div class="attach-file attach-print amount-label">
                                            <label class="gilroy-medium text-B87 f-15 mb-2 mt-24 r-mt-amount r-mt-6" for="address_file">Attach Address Proof</label>
                                            <span class="gilroy-medium text-success f-15"> (approved)</span>
                                            <input type="file" class="form-control upload-filed" name="address_file" id="address_file" required data-value-missing="This field is required.">
                                        </div>
                                        ...
                                        <div class="proof-btn-div d-flex justify-content-start mt-3">
                                            <a href="https://demo.paymoney.techvill.net/kyc-proof-download/1688456225.png/address-proof" class='btn f-10 leading-12 proof-btn p-0 border-DF bg-FFF text-dark'><span>address.png</span>
                                        ...
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-primary px-4 py-2 mt-3" id="addressVerifySubmitBtn">
                                                ...
                                                <span id="addressVerifySubmitBtnText">Verify Address</span>
                                            </button>
                                        </div>
                                    </form>
                                    <!-- 2nd step end-->
