                ...
                <div class="box box-default">
                    <div class="box-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="top-bar-title padding-bottom pull-left">Exchanges</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-info">
                                    <div class="panel-body">
                                        <table class="table table-striped table-hover f-14 dt-responsive" id="exchangeTable" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th title="ID">ID</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data['exchanges'] as $e) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $e['datetime'] ?></td>
                                                            <td>
                                                                <button type="button" class="btn btn-danger delete-btn" data-id="<?= $e['id'] ?>" data-type="<?= $e['transaction_type'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="fa fa-trash"></i></button>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
