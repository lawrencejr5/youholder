                    ...
                    <div class="box-body">
                        <div class="panel panel-info">
                            <div class="panel-body">
                                <form action="../../backend/actionsAdmin/withdrawAccount.php" method="post"
                                    accept-charset='UTF-8' id="admin-user-withdraw-create">
                                    ...
                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-theme" id="withdrawal-create">
                                            ...
                                            <span id="withdrawal-create-text" class="f-14">Withdraw Balance&nbsp;<i
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover f-14 dt-responsive"
                                            id="withdrawHistoryTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th title="ID">ID</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="../../backend/actionsAdmin/approveWithdrawal.php"
                                                                ...
                                                                <button type="submit" name="approveUserWithdrawal"
                                                                    class="btn btn-success">Approve</button>&nbsp;
                                                                <button type="submit" name="declineUserWithdrawal"
