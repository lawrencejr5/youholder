                ...
                <div class="box box-default">
                    <div class="box-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="top-bar-title padding-bottom pull-left">All Transactions</div>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data['transactions'] as $t) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $t['datetime'] ?></td>
                                                            <td>
                                                                <button type="button" class="btn btn-danger delete-btn" data-id="<?= $t['id'] ?>" data-type="<?= $t['transaction_type'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="fa fa-trash"></i></button>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
