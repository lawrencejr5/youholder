        ...
        <ul class="sidebar-menu mt-20">
            ...
            <li class="treeview ">
                ...
                <ul class="treeview-menu">
                    <!-- transactions -->
                    <li class="child ">
                        <a href="../transactions"><i class="fa fa-history"></i><span>All Transactions</span></a>
                    </li>
                    <!-- deposits -->
                    <li class="child ">
                        <a href="../deposits"><i class="fa fa-arrow-down"></i><span>Deposits</span></a>
                    </li>

                    <!-- Payouts -->
                    <li class="child ">
                        <a href="../withdrawals"><i class="fa fa-arrow-up"></i><span>Withdrawals</span></a>
                    </li>

                    <!-- transfers -->
                    <li class="child ">
                        <a href="../transfers"><i class="fa fa-exchange"></i><span>Transfers</span></a>
                    </li>

                    <!-- exchanges -->
                    <li class="child ">
                        <a href="../exchanges"><i class="fa fa-money"></i><span>Currency Exchange</span></a>
                    </li>
            ...
            <!--verifications-->
            <li class="">
                <a href="../kyc"><i class="fa fa-book"></i><span>Kyc verification</span></a>
            </li>
            ...
            <li class="">
                <a href="../wallets"><i class="fa fa-dollar"></i><span>Wallets</span></a>
            </li>
