<header class="main-header">
    ...
    <div class="full-width">
        ...
        <a href="" class="logo pt-6 text-decoration-none">
            <span class="logo-mini"><b style="font-size: 12px;">Yfincs</b></span>
            <img src="https://yfincs.com/public/logos/yield-logo.png" width="150px" height="auto" class="company-logo">
        </a>
    </div>
