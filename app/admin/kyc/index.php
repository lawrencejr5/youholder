                ...
                <div class="box box-default">
                    <div class="box-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <div class="top-bar-title padding-bottom pull-left">Kyc Verifications</div>
                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($data['documents'] as $d) { ?>
                                                        <tr>
                                                            ...
                                                            <!-- <td><?= $d['verified'] ?></td> -->
                                                            <td>
                                                                <form action="../../backend/actionsAdmin/approveKyc.php" method="post" style="display:inline;">
                                                                ...
                                                                <button type="button" class="btn btn-danger delete-btn" data-id="<?= $d['id'] ?>" data-type="kyc" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="fa fa-trash"></i></button>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
