...
<head>
    ...
    <title>Transaction Details | Yield Fiancial Services</title>
            ...
            <div class="containt-parent">
                <div class="main-containt">
                    ...
                    <div class="bg-white pxy-62 shadow" id="depositConfirm">
                        <p class="mb-0 f-26 gilroy-Semibold text-uppercase text-center">Transaction Details</p>
                        ...
                        <form method="post" action="https://demo.paymoney.techvill.net/deposit/gateway" id="depositConfirmForm" enctype="multipart/form-data">
                            ...
                            <?php foreach ($transaction as $t) { ?>
                                ...
                                <div class="mt-32 param-ref text-center transac-box">
                                    <div class="mt-40 transaction-box">
                                        ...
                                        <hr>
                                        <!-- Total -->
                                        <?php if ($t['transaction_type'] !== 'exchange to' && $t['transaction_type'] !== 'exchange from') { ?>
                                            <div class="d-flex justify-content-between mt-3 total">
                                        ...
                                        <?php if ($t['transaction_type'] == 'deposit') { ?>
                                            ...
                                            <hr>
                                        <?php } ?>
                                        <?php if ($t['transaction_type'] == 'exchange to') { ?>
                                            <!-- Total -->
                                            <div class="d-flex justify-content-between mt-3 total">
                                                <p class="mb-0 f-16 gilroy-medium text-dark">Exchange from</p>
                                                <p class="mb-0 f-16 gilroy-medium text-dark"><?= $t['deposit_amt'] ?> <?= $t['currency'] ?></p>
                                            </div>
                                            <hr>
                                            <div class="d-flex justify-content-between mt-3 total">
                                                <p class="mb-0 f-16 gilroy-medium text-dark">Exchange to</p>
                                                <p class="mb-0 f-16 gilroy-medium text-dark"><?= $t['amount'] ?> <?= $t['wallet'] ?></p>
                                            </div>
                                            <hr>
                                        <?php } ?>
                                        <?php if ($t['transaction_type'] == 'exchange from') { ?>
                                            <!-- Total -->
                                            <div class="d-flex justify-content-between mt-3 total">
                                                <p class="mb-0 f-16 gilroy-medium text-dark">Exchange from</p>
                                                <p class="mb-0 f-16 gilroy-medium text-dark"><?= $t['deposit_amt'] ?> <?= $t['currency'] ?></p>
                                        ...
                                        <?php if ($t['transaction_type'] == 'transfer from' || $t['transaction_type'] == 'transfer to') { ?>
                                            <!-- Total -->
                                            <div class="d-flex justify-content-between mt-3 total">
                                                <p class="mb-0 f-16 gilroy-medium text-dark">Note</p>
                            ...
                            <?php } ?>
                            <button class="btn btn-lg btn-primary dash-print-btn mt-24 green-btn" type="button" onclick="window.location = './receipt.php?transac_id=<?= $_GET['transac_id'] ?>&transac_type=<?= $_GET['transac_type'] ?>'">
                                ...
                                <span class="f-12 leading-20 gilroy-medium">View Receipt</span>
                            </button>
