...
$(document).on("click", ".trxn", function (e) {
  ...
  var trans_id = $(this).attr("data"),
    ...
    notificationType = $(this).attr("data-notificationType");
  $.post({
    url: requestPaymentCancelUrl,
    dataType: "json",
    data: { id: trans_id, type: type, notificationType: notificationType },
    beforeSend: function () {
      ...
      checkRequestCreatorStatus()
        .then((res) => {
          ...
          window.location.replace(
            SITE_URL + "/request_payment/accept/" + $(this).attr("data-rel")
          );
        })
        .catch((error) => {
          console.log(error);
