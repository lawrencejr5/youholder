            ...
            <div class="containt-parent">
                <div class="main-containt">
                    ...
                    <div class="bg-white pxy-62" id="invest_add">
                        ...
                        <form method="POST" action="https://demo.paymoney.techvill.net/invest/confirm" id="invest-form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="label-top mt-20">
                                        ...
                                        <input type="hidden" class="form-control input-form-control apply-bg l-s2" value="1" name="plan_id" placeholder="Investment Plan" id="investment-plan" data-type="Range" data-amount="300.00" data-maximum-amount="500.00" data-currency="2" data-payment-methods="1,2,3" data-currency-code="GBP" data-currency-type="fiat">

                                        <input type="text" class="form-control input-form-control apply-bg l-s2" value="Dimond" name="plan" placeholder="Investment Plan" id="plan" required data-value-missing="This field is required." readonly>
